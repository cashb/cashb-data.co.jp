...
<?php require "ml_sg_function.php";	//sendgrid用 ?>
...
// $Referer_check_domain = "www.cashb.co.jp";
...
//		mail($to,$subject,$adminBody,$header);
		sg_mailto($to,$subject,$adminBody,$from,$header);
		if($remail == 1 && !empty($post_mail)) sg_mailto($post_mail,$re_subject,$userBody,$from,$reheader);
	}else{
